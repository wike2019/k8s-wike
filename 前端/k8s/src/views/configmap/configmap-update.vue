...
import {configmapDetail, configmapUpdate} from "../../api/token/configmap/configmap";
  ...
  setup(){
    ...
    async function getItemData(){
      ...
      try {
        ...
        state.form.metadata.name=configmapData.name
        state.form.metadata.namespace=configmapData.namespace
        state.form.data=configmapData.data
