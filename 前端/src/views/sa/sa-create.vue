    ...
    <el-form :inline="true"  :model="form" ref="formRef"  >
      ...
      <el-tabs v-model="state.mode" @tab-click="Update">
        <el-tab-pane label="可视化展示" name="json">
          <metadataInfo tipTitle="ServiceAccount"  @input="getData($event,'metadata',state.form,true)" ref="metadataInfoRef"  :nameRequired="true"></metadataInfo>
...
import {getSaItem, SACreate, SAUpdate} from "../../api/token/sa/sa";
import {useRoute} from "vue-router";
import yaml from "../../components/yaml/yaml.vue";
import {requireRules} from "../../helper/rules.ts"
import {CheckData, createTip, getData } from "../../helper/helper.ts"
